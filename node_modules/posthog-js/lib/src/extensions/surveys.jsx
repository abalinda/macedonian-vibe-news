...
function FeedbackWidget(_a) {
    ...
    return (<Preact.Fragment>
            {((_e = survey.appearance) === null || _e === void 0 ? void 0 : _e.widgetType) === 'tab' && (<button className={"ph-survey-widget-tab ".concat(((_f = survey.appearance) === null || _f === void 0 ? void 0 : _f.tabPosition) === posthog_surveys_types_1.SurveyTabPosition.Top ? 'widget-tab-top' : '')} onClick={toggleSurvey} disabled={readOnly} style={getTabPositionStyles((_g = survey.appearance) === null || _g === void 0 ? void 0 : _g.tabPosition)}>
                    {((_h = survey.appearance) === null || _h === void 0 ? void 0 : _h.widgetLabel) || ''}
                </button>)}
